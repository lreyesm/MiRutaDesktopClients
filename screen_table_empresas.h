#ifndef SCREEN_TABLE_EMPRESAS_H
#define SCREEN_TABLE_EMPRESAS_H
...
namespace Ui {
class Screen_Table_Empresas;
}

class Screen_Table_Empresas : public QMainWindow
{
    Q_OBJECT

public:
    explicit Screen_Table_Empresas(QWidget *parent = nullptr, bool show = true);
    ~Screen_Table_Empresas();

    void getEmpresasFromServer(bool view = true);

signals:
    void empresasReceived(database_comunication::serverRequestType);
