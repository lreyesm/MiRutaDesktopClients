...
void Smtp::sendMail(const QString &from, const QString &to, const QString &subject, const QString &body, QStringList files)
{
    ...
    if(!files.isEmpty())
    {
        ...
        GlobalFunctions::showWarning( 0, tr( "Qt Simple SMTP client" ), tr( "Couldn't open the file\n\n" )  );
                        return ;
                }
...
void Smtp::readyRead()
{
    ...
    {
        // something broke.
        GlobalFunctions::showWarning( 0, tr( "Qt Simple SMTP client" ), tr( "Unexpected reply from SMTP server:\n\n" ) + response );
        state = Close;
